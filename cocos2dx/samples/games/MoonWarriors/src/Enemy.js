...
var Enemy = cc.Sprite.extend({
    ...
    update:function (dt) {
		...
		console.time("Enemy-"+this.eID+" Update Function");
		...
		console.timeEnd("Enemy-"+this.eID+" Update Function");
...
Enemy.create = function (arg) {
	...
	if(Enemy.IDTracker == undefined) {
		Enemy.IDTracker = 1;
	}
	enemy.eID = Enemy.IDTracker++;
